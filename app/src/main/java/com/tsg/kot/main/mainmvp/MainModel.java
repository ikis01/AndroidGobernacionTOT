...
public class MainModel implements MainMVP.Model {
    ...
    @Override
    public void updateMessages(Context context,String token,StudentRemote studentRemote, List<MessageRemote> messageRemoteList){
