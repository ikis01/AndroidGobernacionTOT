...
public class TOTPreferences {
    ...
    private static com.tsg.kot.storage.TOTPreferences _instance;

    public static synchronized com.tsg.kot.storage.TOTPreferences getInstance(Context context) {
        if (_instance == null) {
            _instance = new com.tsg.kot.storage.TOTPreferences(context);
        }
        return _instance;
    }
